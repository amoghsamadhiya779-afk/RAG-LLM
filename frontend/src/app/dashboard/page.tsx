...
function DashboardContent() {
 ...
 <div className="container-page py-10 min-h-[80vh]">
  ...
  <div className="flex space-x-1 rounded-md bg-surface/50 p-1 backdrop-blur-md mb-8 border border-border/50 max-w-fit">
  {[
  ...
  >
   ...
   <div className="grid gap-8 lg:grid-cols-[1fr_2fr]">
    ...
    <>
     ...
     {jobs.map((j) => (
      ...
      className={`glass-card flex w-full items-start justify-between gap-3 p-4 text-left transition-colors hover:border-primary/40 ${selectedJob?.id === j.id ? "border-primary/50 -[0_0_15px_rgba(var(--primary),0.2)]" : ""}`}
      >
   ...
   <div className="glass-card p-10 relative overflow-hidden">
    ...
    {!resumeId ? (
     <div className="col-span-2 p-8 text-center bg-[#1d1d1d]/50 rounded-md border border-[#e5e5e5]/10">
     <p className="text-[#c2c2c2] mb-4">Please upload a resume first to get personalized job recommendations.</p>
     </div>
    ) : isLoadingRecs ? (
     [1, 2, 3, 4].map(i => (
     <div key={i} className="rounded-md border border-[#e5e5e5]/10 bg-[#1d1d1d]/50 p-5 flex flex-col">
     ...
     <div key={job.id} className="rounded-md border border-[#e5e5e5]/10 bg-[#1d1d1d]/80 p-5 flex flex-col hover:border-[#6b62f2]/50 transition-colors">
   ...
   <div className="glass-card p-10 relative overflow-hidden">
    ...
    <div className="space-y-6">
     {!resumeId ? (
     <div className="p-8 text-center bg-[#1d1d1d]/50 rounded-md border border-[#e5e5e5]/10">
    ...
    <div className="rounded-md border border-dashed border-[#6b62f2]/30 bg-[#6b62f2]/5 p-6 flex flex-col justify-center items-center text-center">
   ...
   <div className="glass-card p-10 relative overflow-hidden">
    ...
    <div className="space-y-4">
    <div className="flex items-center justify-between p-4 rounded-md border border-border bg-surface/50">
     <div>
...
export default function Dashboard() {
 return (
 <Suspense fallback={<div className="container-page py-10 animate-pulse h-[80vh] bg-muted/20 rounded-md" />}>
  <DashboardContent />
 </Suspense>
 );
}
