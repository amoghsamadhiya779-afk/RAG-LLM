    ...
    <section className="py-24 sm:py-32">
      <div className="container-page">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-border bg-card px-6 py-20 text-center shadow-soft sm:px-12"
        >
          ...
          <motion.h2 variants={reveal} className="h-display mx-auto max-w-3xl text-4xl sm:text-6xl">
            Your next role is one
            <br />
            <span className="text-gradient-accent">search away.</span>
          </motion.h2>
          <motion.p variants={reveal} className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-muted-foreground sm:text-lg">
          ...
          <motion.div variants={reveal} className="mt-9 flex flex-wrap items-center justify-center gap-3">
            ...
            <Link href="/post">
              <Button size="lg" variant="outline" className="h-11 rounded-full border-border bg-transparent px-6 text-sm font-medium">
                Post a job
              </Button>
            </Link>
          </motion.div>
