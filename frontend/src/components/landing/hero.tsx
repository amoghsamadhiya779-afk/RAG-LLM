      ...
      >
        ...
        <div className="lg:col-span-5 lg:pr-8 flex flex-col justify-center">
          <motion.div variants={reveal}>
            <p className="mb-4 text-[15px] font-medium text-bone">
              Introducing jOBiON
            </p>
          </motion.div>
          ...
          <motion.div variants={reveal} className="mt-16 max-w-sm">
            <h3 className="mb-4 text-[16px] font-medium text-bone">What jOBiON handles for you</h3>
            <div className="flex flex-col gap-2">
              {[
                ...
                <div key={i} className="flex h-10 items-center justify-between border-t border-bone/[0.06]">
                  ...
                  <span className="text-[14px] font-medium text-fog">0{i + 1}</span>
                </div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="lg:col-span-7">
          <motion.div variants={reveal} className="relative w-full h-full min-h-[500px]">
            ...
            <div className="glass-card absolute inset-0 overflow-hidden flex flex-col p-8 lg:p-12">
              ...
              <h2 className="text-[32px] font-medium text-paper">Semantic Search</h2>
              ...
              <div className="mt-16 flex flex-col gap-3">
                {[
                  ...
                  <div key={i} className="flex h-16 items-center justify-between rounded-2xl bg-ink/60 p-4 backdrop-blur-lg border border-bone/[0.04]">
                    <div>
                      <h4 className="font-geist text-[15px] font-medium text-bone">{job.title}</h4>
                      <p className="text-[13px] text-mist">{job.company}</p>
                    </div>
                    <span className="flex h-8 items-center justify-center rounded-pill bg-indigo-haze/20 px-3 text-[13px] font-bold text-bone shadow-sm">
