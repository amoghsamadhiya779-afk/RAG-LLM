...
export function PipelineVisual() {
  return (
    <div className="overflow-hidden rounded-xl bg-muted p-4">
      <div className="mb-4 flex items-center justify-between">
        <div>
          <div className="text-xs text-muted-foreground">Senior Full-Stack Engineer</div>
          <div className="text-sm font-semibold">Applicant pipeline</div>
        </div>
        <span className="rounded-full bg-gradient-accent px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-white">
          Featured
        </span>
      </div>
          ...
          >
            ...
            <div className="space-y-1.5">
              {col.items.map((name, i) => (
                ...
                >
                  <span className="grid h-5 w-5 place-items-center rounded-full bg-muted text-[9px] font-semibold">
