          ...
          {tiers.map((t) => (
            <motion.div
              ...
              className={`relative flex flex-col rounded-2xl border p-7 ${
                t.highlighted
                  ? "border-transparent bg-card shadow-lift lg:-mt-4 lg:mb-[-1rem]"
            ...
            >
              {t.highlighted && (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-gradient-accent px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-white shadow-lift">
                  Popular
                </span>
              )}
