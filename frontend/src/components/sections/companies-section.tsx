   ...
   <div className="container-page">
    <div className="mb-12 text-center">
     <h2 className="text-h1 font-display font-display tracking-tight sm:text-display">
      Companies <span className="text-primary font-bold">Hiring</span>
     </h2>
    ...
    {isLoading ? (
     ...
     <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {companies.map((c: any, i: number) => (
       ...
       >
        <Link to="/companies/$id" params={{ id: c.slug || c.id }} className="block p-6 rounded-lg bg-card border border-border transition-colors hover:border-primary/50">
         <div className="flex items-center gap-3">
          ...
          <div>
           <h3 className="font-geist text-[17px] font-heading text-white">{c.name}</h3>
