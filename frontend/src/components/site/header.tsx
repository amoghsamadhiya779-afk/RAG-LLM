    ...
    <header className="fixed top-0 left-0 right-0 z-[var(--z-sticky)] border-b border-[rgba(255,255,255,0.08)] bg-background/70 backdrop-blur-md backdrop-saturate-150">
      <div className="container-page flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link href="/dashboard" className="inline-flex h-9 items-center justify-center rounded-pill bg-paper px-4 text-[14px] font-ui text-void transition-colors hover:bg-paper/90">
            Post a Job
          </Link>
        </div>
      </div>
