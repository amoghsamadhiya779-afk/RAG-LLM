...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    // Respect reduced motion: paint one static frame, skip the RAF loop entirely.
    ...
    // Pause the RAF loop when the tab is hidden; resume on visibility.
    const startLoop = () => {
    ...
    const onVisibility = () => {
      if (document.hidden || prefersReduced) stopLoop();
      else startLoop();
    };
