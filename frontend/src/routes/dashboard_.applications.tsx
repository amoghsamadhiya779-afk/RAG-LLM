...
function TimelineItem({ application, index }: { application: Application; index: number }) {
  ...
  return (
    ...
    >
      ...
      <GlassPanel className="p-4 transition-all hover:border-border">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
              <span className="inline-flex items-center gap-1">
                ...
                {typeof application.job.company === "string" ? application.job.company : application.job.company?.name || "Unknown"}
              </span>
              <span>·</span>
