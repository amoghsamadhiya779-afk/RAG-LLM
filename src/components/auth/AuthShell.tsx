  ...
  return (
    <div className="relative min-h-[100svh] bg-background text-foreground">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle_at_center,rgba(46,111,255,0.28),transparent_65%)] blur-3xl" />
        <div className="absolute -bottom-40 -right-40 h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle_at_center,rgba(106,162,255,0.22),transparent_65%)] blur-3xl" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(76,130,255,0.10),transparent_70%)]" />
      </div>

      <Link
        to="/"
        className="absolute left-4 top-4 z-20 inline-flex items-center gap-2 rounded-full border border-border bg-foreground/[0.04] px-3 py-1.5 text-xs text-foreground/70 backdrop-blur-md transition hover:bg-foreground/[0.08] hover:text-foreground sm:left-6 sm:top-6"
      >
