    ...
    <section id="how" className="relative py-28">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <StaggerGroup className="mt-14 grid gap-6 md:grid-cols-3">
          {STEPS.map((s, i) => (
            <GlassPanel key={s.title} className="group relative overflow-hidden p-6">
              <div className="absolute -right-16 -top-16 h-40 w-40 rounded-full opacity-0 blur-3xl transition-opacity duration-500 group-hover:opacity-40"
