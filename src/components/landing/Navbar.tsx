...
export function Navbar() {
  ...
  const navDelay = introWillPlay() ? HERO_ENTRANCE_DELAY_S : 0;

  return (
    <header 
      className="pointer-events-none sticky top-0 z-40 animate-in fade-in slide-in-from-top-4 duration-1000 fill-mode-both"
      style={{ animationDelay: `${navDelay}s` }}
    >
